...
_USERINFORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="user.UserInfoResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="login",
            full_name="user.UserInfoResponse.login",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="email",
            full_name="user.UserInfoResponse.email",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="role",
            full_name="user.UserInfoResponse.role",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
